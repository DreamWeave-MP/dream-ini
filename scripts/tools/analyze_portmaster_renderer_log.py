...
SELECTED_COUNTERS = {
    ...
    "primitive_stats": ("mesh_primitives", "mesh_indices", "mesh_triangles", "quad_windows", "axis_aligned_quad_windows", "solid_quad_fast_path_hits", "textured_quad_fast_path_hits", "textured_quad_reject_not_axis_aligned_rectangle", "textured_quad_reject_non_uniform_color", "solid_fan_accepted_runs", "solid_fan_accepted_triangles", "generic_triangles_rasterized", "generic_solid_triangles", "generic_textured_triangles", "degenerate_triangles"),
    "raster_stats": ("solid_rect_calls", "solid_rect_px", "textured_rect_calls", "textured_rect_px", "textured_rect_sampled_us", "solid_triangle_calls", "solid_triangle_candidate_px", "solid_fan_calls", "solid_fan_px", "solid_fan_span_cache_hits", "solid_fan_span_cache_misses", "textured_triangle_calls", "textured_triangle_candidate_px", "sampled_textured_triangle_us", "opaque_px", "translucent_px", "transparent_px"),
    "raster_timings": ("quad_window_probe_us", "solid_quad_us", "textured_quad_us", "solid_fan_probe_us", "solid_fan_raster_us", "generic_solid_triangle_us", "generic_textured_triangle_us"),
