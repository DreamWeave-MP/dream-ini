...
SELECTED_COUNTERS = {
    ...
    "primitive_stats": ("mesh_primitives", "mesh_indices", "mesh_triangles", "quad_windows", "axis_aligned_quad_windows", "solid_quad_fast_path_hits", "textured_quad_fast_path_hits", "textured_quad_reject_not_axis_aligned_rectangle", "textured_quad_reject_non_uniform_color", "solid_fan_preflight_reject_too_few_triangles", "solid_fan_rejected_probe_calls", "solid_fan_accepted_candidate_triangles_scanned", "solid_fan_rejected_candidate_triangles_scanned", "solid_fan_accepted_runs", "solid_fan_accepted_triangles", "generic_triangles_rasterized", "generic_solid_triangles", "generic_textured_triangles", "generic_textured_constant_texel_triangles", "generic_textured_sampled_triangles", "degenerate_triangles"),
