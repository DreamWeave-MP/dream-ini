...
pub(super) const fn text(key: UiText) -> &'static str {
    match key {
        ...
        UiText::EncodingUseCfgDefault => "cfg/predeterminado",
        ...
        UiText::Copy => "Copiar",
        UiText::Clear => "Borrar",
        UiText::EncodingTooltip => "Codificación de caracteres usada al leer Morrowind.ini.",
        ...
        UiText::RelativeDataRequiresCfgOrOutput => {
            "Las rutas de instalación relativas requieren un cfg existente o una ruta de salida."
        }
