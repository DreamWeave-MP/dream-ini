...
pub(super) const fn text(key: UiText) -> &'static str {
    match key {
        ...
        UiText::ControllerHelp => {
            "Mando: cruceta/stick izquierdo mueve • A alterna/elige • B sale • X borra la ruta seleccionada • Start importa cuando esté listo • izquierda/derecha ajusta opciones • stick derecho desplaza el cfg generado • LB/RB pagina el cfg generado"
        }
