...
pub(super) struct SolidFanProbeStats {
    ...
    pub(super) preflight_second_triangle_checks: usize,
    pub(super) preflight_reject_no_second_triangle_continuation: usize,
    pub(super) preflight_center_slots_allowed: usize,
    pub(super) preflight_center_slots_rejected: usize,
...
impl PrimitiveStats {
    ...
    pub(super) fn log_line(&self, frame_index: u64) -> String {
        ...
        format!(
            ...
            self.solid_fan_probe.preflight_second_triangle_checks,
            self.solid_fan_probe
                .preflight_reject_no_second_triangle_continuation,
            self.solid_fan_probe.preflight_center_slots_allowed,
            self.solid_fan_probe.preflight_center_slots_rejected,
...
mod tests {
    ...
    fn primitive_stats_classifies_generic_triangles_and_log_line() {
        ...
        stats.solid_fan_probe.preflight_second_triangle_checks = 5;
        stats
            .solid_fan_probe
            .preflight_reject_no_second_triangle_continuation = 6;
        stats.solid_fan_probe.preflight_center_slots_allowed = 7;
        stats.solid_fan_probe.preflight_center_slots_rejected = 8;
        ...
        assert!(log_line.contains("solid_fan_preflight_second_triangle_checks=5"));
        assert!(log_line.contains("solid_fan_preflight_reject_no_second_triangle_continuation=6"));
        assert!(log_line.contains("solid_fan_preflight_center_slots_allowed=7"));
        assert!(log_line.contains("solid_fan_preflight_center_slots_rejected=8"));
