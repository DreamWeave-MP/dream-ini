...
mod tests {
    ...
    macro_rules! populated_raster_stats {
        () => {
            RasterStats {
                ...
                degenerate_triangle_skips: 111,
                fully_clipped_triangle_skips: 112,
                opaque_px: 113,
                translucent_px: 114,
                transparent_px: 115,
            }
    ...
    fn raster_stats_log_line_includes_all_counters() {
        ...
        assert_eq!(actual_values, (1..=115).collect::<Vec<_>>());
    }
}
