...
mod tests {
    ...
    macro_rules! populated_raster_stats {
        () => {
            RasterStats {
                ...
                textured_rect_sampled_vector_blocks: 141,
                textured_rect_sampled_vector_opaque_blocks: 142,
                textured_rect_sampled_vector_transparent_blocks: 143,
                textured_rect_sampled_vector_mixed_blocks: 144,
                textured_rect_sampled_vector_tail_px: 145,
                textured_rect_separable_run_px_buckets_le1_le2_le4_le8_le16_gt16: [
                    146, 147, 148, 149, 150, 151,
                ],
                degenerate_triangle_skips: 152,
                fully_clipped_triangle_skips: 153,
                opaque_px: 154,
                translucent_px: 155,
                transparent_px: 156,
            }
    ...
    fn raster_stats_log_line_includes_all_counters() {
        ...
        assert!(line.contains(
            " textured_rect_separable_run_px_buckets_le1_le2_le4_le8_le16_gt16=146,147,148,149,150,151 "
        ));
        ...
        assert!(line.contains(" textured_rect_sampled_vector_tail_px=145 "));
        assert_eq!(
            actual_values,
            (1..=145).chain(152..=156).collect::<Vec<_>>()
        );
    }
}
