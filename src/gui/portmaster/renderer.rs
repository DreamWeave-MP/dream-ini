...
use super::raster::{
    ClipBounds, RasterStats, SolidTriangleColorDecision, classify_triangle,
...
use stats::{
    PrimitiveStats, RasterTimings, TriangleSource, record_quad_probe_elapsed,
    record_solid_quad_elapsed, record_solid_quad_reject_elapsed, record_textured_quad_elapsed,
